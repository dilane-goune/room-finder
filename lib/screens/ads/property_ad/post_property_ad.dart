...
class _PostPropertyAdController extends LoadingController {
  ...
  String get _appBarSubTitle {
    switch (_pageIndex.value) {
      case 0:
        return "whatAreYouPosting".tr;
      case 1:
        return "aboutYourProperty".tr;
      case 2:
        return "whoAreYou".tr;
      case 3:
        return "whereIsYourProperty".tr;
      case 4:
        return "videoAndImages".tr;
      case 5:
        return "socialPreferences".tr;
      case 6:
        return "amenties".tr;
      case 7:
        return "Payment".tr;
            ...
            child: PageView(
              ...
              children: [
                ...
                SingleChildScrollView(
                  child: Column(
                    children: ["Bed", "Partition", "Room", "Master Room", "Mix"]
                        .map((e) {
                      return Container(
                      ...
                      children: [
                        ...
                        DropdownButtonFormField<String>(
                          ...
                          onChanged: controller.isLoading.isTrue
                              ...
                              : (val) {
                                  if (val != null) {
                                    controller.information["preferedRentType"] =
                                        val;
                                  }
                                },
                        ),
                        ...
                        for (final item in [
                          ...
                          TextFormField(
                            initialValue:
                                controller.information[item['value']] as String,
                            enabled: controller.isLoading.isFalse,
                            ...
                            onChanged: (value) =>
                                controller.information[item['value']!] = value,
                            validator: (value) {
                        ...
                        Container(
                          ...
                          child: CheckboxListTile(
                            value: controller.information["deposit"] as bool,
                            onChanged: (val) {
                              if (val != null) {
                        ...
                        if (controller.information["deposit"] == true)
                          TextFormField(
                            ...
                            onChanged: (value) =>
                                controller.information["depositFee"] = value,
                            validator: (value) {
                              if (value == null || value.trim().isEmpty) {
                                return 'thisFieldIsRequired'.tr;
                              }
                      ...
                      Column(
                        ...
                        children: ["Landlord", "Agent/Broker"].map((e) {
                          return Container(
                            ...
                            child: RadioListTile<String>(
                              value: e,
                              groupValue: controller.information["posterType"]
                                  as String,
                              onChanged: (value) {
                                if (value != null) {
                                  controller.information["posterType"] = value;
                                }
                              },
                              title: Text(e),
                            ),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              TextFormField(
                                ...
                                enabled: controller.isLoading.isFalse,
                                decoration:
                                    InputDecoration(hintText: 'firstName'.tr),
                              ...
                              TextFormField(
                                ...
                                enabled: controller.isLoading.isFalse,
                                decoration:
                                    InputDecoration(hintText: 'lastName'.tr),
                                onChanged: (value) => controller
                                    .agentBrokerInformation["lastName"] = value,
                                validator: (value) {
                                  if (value == null || value.isEmpty) {
                                    return 'thisFieldIsRequired'.tr;
                                  }
                              ...
                              TextFormField(
                                initialValue:
                                    controller.agentBrokerInformation["email"],
                                enabled: controller.isLoading.isFalse,
                                decoration:
                                    InputDecoration(hintText: 'email'.tr),
                                onChanged: (value) => controller
                                    .agentBrokerInformation["email"] = value,
                                validator: (value) {
                                  if (value == null || value.isEmpty) {
                                    return 'thisFieldIsRequired'.tr;
                                  }
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      DropdownButtonFormField<String>(
                        ...
                        value: controller.socialPreferences["numberOfPeople"]
                            as String,
                        items: [
                          "1 to 5",
                          "5 to 10",
                      ...
                      DropdownButtonFormField<String>(
                        ...
                        onChanged: controller.isLoading.isTrue
                            ...
                            : (val) {
                                if (val != null) {
                                  controller.socialPreferences["nationality"] =
                                      val;
                                }
                              },
                      ),
                      ...
                      DropdownButtonFormField<String>(
                        decoration: InputDecoration(
                          hintText: 'gender'.tr,
                          helperText:
                              'Gender of people who live in your property'.tr,
                        ),
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              FlutterSwitch(
                                value:
                                    controller.socialPreferences[item] as bool,
                                onToggle: (value) {
