...
import 'package:room_finder/screens/ads/roomate_ad/post_roommate_ad.dart';
...
class _ViewRoommateAdController extends LoadingController {
  ...
  Future<void> bookRoommate(RoommateAd ad) async {
    final shouldContinue = await showConfirmDialog(
    ...
    try {
      isLoading(true);
      final res = await ApiService.getDio.post("/bookings/roommate-ad/", data: {
        'landlordId': ad.poster.id,
        'adId': ad.id,
        'adType': "ROOMMATE",
        'recieverFcmToken': ad.poster.fcmToken,
      ...
      if (res.statusCode == 200) {
        ...
        isLoading(false);
        await showConfirmDialog(
          "You have already book this room. Wait for the landlord reply",
          isAlert: true,
        );
      } else {
        showGetSnackbar(
...
class ViewRoommateAdScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Loooking for roomate"),
      ),
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Text(
                "${ad.poster.fullName}, ${ad.poster.gender}(${ad.aboutYou["age"]})",
                style: const TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.bold,
                ),
              ...
              Row(
                  children: (ad.aboutYou['languages'] as List)
                      .map((e) => Text("$e, "))
                      .toList()),
              const SizedBox(height: 5),
              const Text("Feel confortable with",
              ...
              GridView.count(
                ...
                children: [
                  PrpertyAdOverviewItemWidget(
                    ...
                    value: "${ad.socialPreferences["numberOfPeople"]} peoples",
                  ),
                  PrpertyAdOverviewItemWidget(
              ...
              GridView.count(
                ...
                shrinkWrap: true,
                childAspectRatio: 5,
                children: (ad.aboutYou["interests"] as List).map((e) {
                            ...
                            OutlinedButton(
                              onPressed: () async {
                                ...
                                if (date != null) {
                                  ...
                                  if (date.isAfter(controller.checkOut.value)) {
                                    controller._resetDates();
                                  }
                                }
                              },
              ...
              Builder(builder: (context) {
                ...
                return SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: controller.isLoading.isTrue
                        ? null
                        : () => controller.bookRoommate(ad),
                    child: const Text("Book Ad"),
                  ),
                );
              })
            ],
