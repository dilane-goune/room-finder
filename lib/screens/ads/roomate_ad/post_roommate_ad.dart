                      ...
                      children: [
                        ...
                        TypeAheadFormField<String>(
                          ...
                          onSuggestionSelected: (suggestion) {
                            controller.address["country"] = suggestion;
                          ...
                          onSaved: (newValue) {
                            if (newValue != null) {
                              controller.address["country"] = newValue;
                    ...
                    children: [
                      ...
                      Center(
                        child: ElevatedButton(
                          onPressed: () {
                            final isValid = controller._cardFormKey.currentState
                                ?.validate();
            ...
            child: Builder(builder: (context) {
              ...
              return Row(
                ...
                children: [
                  ...
                  Text('${controller._pageIndex.value + 1}/4'),
                  TextButton(
                    onPressed: controller.isLoading.isTrue
                        ? null
                        : () {
